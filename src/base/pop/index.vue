...
<script>
    ...
    import {hasClass,addClass,removeClass} from '@/common/js/utils/dom'
    export default {
        name: 'popup',
        props: {
            value: Boolean,
        ...
        methods: {
            ...
            removeModalClassName () {
                this.layout === 'VIEW_BOX' && removeClass(document.body, 'vux-modal-open')
            }
        },
        data () {
            return {
        ...
        watch: {
            ...
            show (val) {
                ...
                if (val) {
                    ...
                    this.layout === 'VIEW_BOX' && addClass(document.body, 'vux-modal-open')
